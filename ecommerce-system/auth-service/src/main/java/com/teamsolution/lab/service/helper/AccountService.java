...
public class AccountService {
  ...
  public Set<String> getActiveRoleNamesByAccountId(UUID accountId) {
    ...
    Set<Role> roles =
        accountRoleRepository.findActiveRolesByAccountId(
            account.getId(), AccountRoleStatus.ACTIVE, RoleStatus.ACTIVE);
  ...
  @Transactional
  public void findOrCreateGoogleAccount(String email, String fullName, String avatarUrl) {
    accountRepository
        .findByEmail(email)
        .orElseGet(
            () ->
